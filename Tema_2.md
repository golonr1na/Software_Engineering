...
1. `print(1748-293)`: Выводится целое число 1455. Это результат вычитания двух целочисленных пересенных типа int в виде переменной типа int.

2. `print(4.8+9.23)`: Выводится число с плавающей точкой 14.030000000000001. Это результат сложения двух переменных типа float.

3. `print(6+3.94+2+4.45)`: Выводится число с плавающей точкой 16.39. Это результат сложения двух целочисленных и двух чисел с плавающей точкой.
