...
```mermaid
flowchart TD
start[Старт]-->input[Ввод числа в консоль]-->C1{Введеное число присутвует в списке?}
C1 --> |Yes| C2{Число делится на 2 без отстатка?}
C1 --> |No| pr3[Вывод "Переменной нет в массиве numbers"] --> e[Конец]
C2 --> |Yes| pr1[Вывод "Переменная четная и есть в массиве numbers"] --> e[Конец]
C2 --> |No| pr2[Вывод "Переменная не четная и есть в массиве numbers"] --> e[Конец]
```
