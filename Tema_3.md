...
cond2=>condition2: Число делится на 2 без отстатка?
op1=>operation1: Вывод "Переменная четная и есть в массиве numbers"
op2=>operation2: Вывод "Переменная не четная и есть в массиве numbers"
